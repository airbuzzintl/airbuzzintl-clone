...
const Career = () => {
  ...
  return (
    <>
    <Wrapper bg={images.CareersBg} class="bg-animation">
      <div id="stars"></div>
      <div id="stars2"></div>
      <div id="stars3"></div>
      <div id="stars4"></div>
      <div id="stars4"></div>
      <div
        style={{ position: "absolute", top: "6rem", left: "6rem", zIndex: 99 }}
      >
            ...
            <GlassyBackground>
              <Form style={{ padding: "1rem" }}>
                ...
                <FormInputFields
                  ...
                  placeholder={"Upload CV  *which can be either an image or a pdf."}
                />
                <Box mt={1} />
