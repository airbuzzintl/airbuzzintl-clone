...
import InternationalBg from "../../assets/International Image.jpg";
import DomesticBG from "../../assets/Domestice Image.jpg";
export const images = {
  career: career,
  ...
  FaqBg: FaqBg,
  Blogsbg: Blogsbg,
  InternationalBg: InternationalBg,
  DomesticBG: DomesticBG,
};
