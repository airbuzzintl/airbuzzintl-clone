...
const SocialMediaCard = ({ data }) => {
  ...
  function convertShortsToEmbedUrl(url) {
    if (!url) return null;
    ...
    try {
      ...
      // Handle standard YouTube URL with watch?v=VIDEO_ID
      if (parsedUrl.searchParams.has("v")) {
        const videoId = parsedUrl.searchParams.get("v");
        return `https://www.youtube.com/embed/${videoId}`;
      }

      // If already an embed link or fallback
      return url;
    } catch (e) {
      return null;
    }
      ...
      >
        ...
        >
          <Box>
            ...
            <Image src={AirbuszzLogo} alt="logo" style={{ width: "35px" }} />
          </Box>
            ...
            >
              <Box sx={style}>
                <iframe
                  ...
                  height="315"
                  // src={data.url}
                  src={convertShortsToEmbedUrl(data.url)}
